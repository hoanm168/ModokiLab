...
namespace ModokiLab.ViewModels
{
    sealed class ConfigViewModel : ViewModel
    {
        ...
        {
            _InputCommand = new ViewModelCommand(Input, () => !String.IsNullOrEmpty(PinCode));
        }
        ...
        #region InputCommand変更通知プロパティ
        private ViewModelCommand _InputCommand;

        public ViewModelCommand InputCommand
        {
